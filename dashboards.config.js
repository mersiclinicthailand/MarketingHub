...
window.HUB_CONFIG = {
  ...
  api: {
    url: "https://script.google.com/macros/s/AKfycbwktZZNjLakhKH4kV2jL5W9J2DuZDpQOrA1_AOwbmey3bYPqmYyc82YfHCyOhV0qFGL/exec",
  },

  /* ---------- ผู้ใช้ + สิทธิ์ ----------
     role "admin" เห็นทุก dashboard · role อื่นเห็นเฉพาะที่ระบุไว้
     passwordHash = SHA-256 → สร้างจาก hash-tool.html
     ค่าเริ่มต้น: admin/admin1234, it/it1234, marketing/mkt1234, area/area1234
     ⚠️ เปลี่ยนรหัสก่อนใช้งานจริง                                    */
  /* ---------- บทบาท & สิทธิ์ (แก้ได้จากหน้าเว็บ: ศูนย์ควบคุมระบบ → บทบาท) ----------
     manage  = เข้าศูนย์ควบคุมระบบได้ → เพิ่ม/แก้ ผู้ใช้ · dashboard · หมวดหมู่ · บทบาท
     allDash = เห็นทุก dashboard อัตโนมัติ (ไม่ต้องระบุสิทธิ์รายตัว)
     เพิ่มบทบาทใหม่ได้เอง เช่น hr / finance / branch แล้วผูกกับผู้ใช้ได้ทันที   */
  roles: [
    { id: "admin",     label: "ผู้ดูแลระบบ (Admin)",    manage: true,  allDash: true  },
    { id: "it",        label: "ฝ่าย IT (IT Support)",    manage: true,  allDash: true  },
    { id: "marketing", label: "ทีมการตลาด (Marketing)", manage: false, allDash: false },
    { id: "area",      label: "ผู้จัดการเขต (Area)",     manage: false, allDash: false },
  ],
  ...
  users: [
    ...
    /* ★ บัญชีฝ่าย IT — รหัสเริ่มต้น it1234 · เปลี่ยนรหัสทันทีหลังเข้าใช้ครั้งแรก
       IT เพิ่ม/แก้ไขผู้ใช้และ dashboard ได้จากหน้าเว็บ ไม่ต้องแก้ไฟล์นี้อีก      */
    { username: "it",        displayName: "IT Support", role: "it",
      passwordHash: "44866f79cb6499c9fcf0f41b8002968871244ab89704210fa06976488e7e45f7" },
